...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        .input(zod_1.z.object({ productIds: zod_1.z.array(zod_1.z.string().min(1)).min(1) }))
        .mutation(function (_a) {
        var ctx = _a.ctx, input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filterProducts, order, line_items, idempotencyKey, stripeSession, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        order = _b.sent();
                        line_items = [];
                        filterProducts.forEach(function (products) {
                            line_items.push({
                    ...
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        idempotencyKey = "checkout_".concat(order.id);
