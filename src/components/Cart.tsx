      ...
      <div className="relative flex items-center justify-center">
        <Sheet>
          ...
          <div className="flex fixed">
            <SheetContent className="flex bg-black w-full flex-col pr-0 sm:max-w-lg text-gray-100 ">
              ...
              {itemCount > 0 ? (
                ...
                <div className="flex h-full flex-col items-center justify-center space-y-1">
                  <div
                    aria-hidden="true"
                    className="flex content-center w-full flex-col items-center justify-center h-64"
                  >
                    {/* <Image
                  ...
                  ></Image> */}
                    <div className="mt-[-200px] relative  text-muted-foreground justify-center content-center inset-0 flex-col flex h-full bg-slate-950 rounded-lg mb-90">
                      <h1 className="flex items-center justify-center px-9  text-white text-xl rounded-md">
                        Your Cart is empty. Check your Saved for later items
                        below or continue shopping.
                      </h1>
                    </div>
                  </div>
                </div>
